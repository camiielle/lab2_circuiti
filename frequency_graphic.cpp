...
void grafico_frequenze() {
  ...
  //fitting. Let V_0 = 4.791 V
  TF1* fitwoofer = new TF1("fitwoofer","4.791/(sqrt([0]*[0]+4*pi*pi*(x*x)*([1]*[1])))",2000,11000);
  ...
  TF1* fittweeter = new TF1("fittweeter","4.791/(sqrt([0]*[0]+1/(4*pi*pi*x*x*[1]*[1])))",2000,11000);
  ...
  TF1* fitmidrange = new TF1("fitmidrange","4.791/(sqrt( [0]*[0] + ( [1]*x*2*pi - (1/([2]*x*2*pi)) )^2 ))",2000,11000);
