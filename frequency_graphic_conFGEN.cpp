...
void grafico_frequenze() {
  ...
  TGraphErrors *graph_W = new TGraphErrors("Ampiezza_w_div_vin.txt", "%lg %lg %lg");
  mg->Add(graph_W);

  TGraphErrors *graph_T = new TGraphErrors("Ampiezza_t_div_vin.txt", "%lg %lg %lg");
  mg->Add(graph_T);

  TGraphErrors *graph_M = new TGraphErrors("Ampiezza_m_div_vin.txt", "%lg %lg %lg");
  mg->Add(graph_M);
